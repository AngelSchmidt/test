...
var imageRepository = new function() {
	...
	// Set images src
	this.background.src = "imgs/stars.jpg";
	this.spaceship.src = "imgs/Arwing.png";
	this.bullet.src = "imgs/bullet.png";
	this.enemy.src = "imgs/Wolfen.png";
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.backgroundAudio = new Audio("sounds2/Star Fox Corneria Theme.mp3");
			this.backgroundAudio.loop = true;
			this.backgroundAudio.volume = .25;
			this.backgroundAudio.load();

			this.gameOverAudio = new Audio("sounds2/boost.mp3");
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			for (var i = 0; i < size; i++) {
				// Initalize the object
				laser = new Audio("sounds2/arwingSingleLaserTwoShots.mp3");
				laser.volume = .12;
				laser.load();
				pool[i] = laser;
			}
